...
public class RegVacuna extends JFrame {
	...
	public RegVacuna() {
		...
		spnFecha.setModel(new SpinnerDateModel(new Date(1637640000000L), null, null, Calendar.DAY_OF_MONTH));
		spnFecha.setBounds(10, 177, 302, 25);
		panel.add(spnFecha);
		...
		JLabel lblNewLabel_1 = new JLabel("Fecha de creaci\u00F3n: ");
